...
# Player profile management and display
...
def show_profile(screen, clock, font, big_font, profile_data):
    ...
    while True:
        ...
        change_name_width = max(100, int(screen_width * 0.16))
        ...
        pygame.draw.rect(screen, (70, 130, 180), change_name_rect, border_radius=16)
        change_name_label = button_font.render("Change Name", True, (255, 255, 255))
